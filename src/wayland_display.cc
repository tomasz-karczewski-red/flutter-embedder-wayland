...
static double get_pixel_ratio(int32_t physical_width, int32_t physical_height, int32_t pixels_width, int32_t pixels_height) {
  ...
  const auto pixel_width_mm  = physical_width * 1000 / pixels_width;
  const auto pixel_height_mm = physical_height * 1000 / pixels_height;
  const double pixel_ratio   = (double)pixel_width_mm / pixel_height_mm;
